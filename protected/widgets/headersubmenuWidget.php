...
class HeadersubmenuWidget extends CJuiWidget
{       
        /**
        ...
        public $model;
        public $data;
        public $view = array('modify'=>'headersubmenus','view'=>'headersubmenus'); // render views modify , view
        ...
        {
			$assets = Yii::app()->getAssetManager()->publish( Yii::getPathOfAlias('application.widgets').'/assets/',false,-1,true);
            $cs = Yii::app()->getClientScript();
            $cs->registerScriptFile($assets . '/js/headersubmenu.js?'.time());
