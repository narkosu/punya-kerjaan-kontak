...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="rows">
        ...
        <?php echo $form->textArea($newComment, 'comment_text', array('cols' => 0, 'rows' => 0,'style'=>'width:100%;height:auto;')); ?>
    ...
    <?php endif; ?>
	<div>
	<?php echo CHtml::button('Simpan komentar',array('style'=>'height:30px;','class'=>'save-comment')); ?>
	</div>
<?php $this->endWidget(); ?>
</div><!-- form -->
