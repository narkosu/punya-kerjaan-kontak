...
class OrderPosition extends CActiveRecord
{
	...
	{
		return array(
			array('order_id, product_id, amount, specifications,product_name,product_price', 'required'),
			array('order_id, product_id, amount,product_price,total_price', 'numerical', 'integerOnly'=>true),
