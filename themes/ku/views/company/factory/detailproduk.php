<div id="detail-product">
    ...
    <?php
      $this->widget(
      'application.extensions.cloudzoom.CloudZoom',
          array('options'=>array('softFocus:'=>'true'))
      );
      
      $this->renderPartial('_imageproduk', array( 'model' => $model));
    ?>
     ...
     */?>
    <?php 
    if ( $model->isMine(Yii::app()->user->getState('storeLogin')->company_id)){ 
    ?>
      <div>Edit Produk</div>
    <?php
    }
